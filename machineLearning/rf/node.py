...
class Node():
    ...
    # initializer
    def __init__(self, level: int = 0, parent: int = None, isRoot: bool = False) -> None:
    ...
    def fromDict(self, loadDict: dict) -> dict:
    ...
    def setValues(self, targets: ArrayLike) -> None:
        self._rawValues = targets

    @property
    def raws(self) -> np.ndarray:
        if self.hasChildren:
            left = self.left.raws
