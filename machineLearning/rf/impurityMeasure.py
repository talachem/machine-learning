...
class ImpurityMeasure(ABC):
    ...
    def __call__(self, targets: ArrayLike, *, weights: Optional[ArrayLike] = None, classWeights: Optional[ArrayLike] = None) -> float:
        """
    ...
    @abstractmethod
    def _loss(self, targets: ArrayLike, *, weights: Optional[ArrayLike] = None, classWeights: Optional[ArrayLike] = None) -> float:
        """
