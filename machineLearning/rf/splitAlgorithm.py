...
class SplitAlgorithm(ABC):
    ...
    """
    def __init__(self, featurePercentile: Optional[int] = None, threads: int = 4, executor: str = 'thread') -> None:
    ...
    def __call__(self, data: ArrayLike, targets: ArrayLike, *, weights: Optional[ArrayLike] = None, classWeights: Optional[ArrayLike] = None) -> tuple[float, int, float]:
        """
    ...
    def getPercentiles(self, features: ArrayLike) -> np.ndarray:
        """
    ...
    @abstractmethod
    def _calculateInfoGain(self, feat: int, data: DataSet) -> tuple[float, int, float]:
        pass
    ...
    def findBestSplit(self, data: ArrayLike, targets: ArrayLike, *, weights: Optional[ArrayLike] = None, classWeights: Optional[ArrayLike] = None) -> tuple[Optional[int], Optional[float]]:
...
class CART(SplitAlgorithm):
    ...
    def _calculateInfoGain(self, feat: int, data: ArrayLike, targets: ArrayLike, *, weights: Optional[ArrayLike] = None, classWeights: Optional[ArrayLike] = None) -> tuple[float, int, float]:
        line = data[:, feat]
...
class ID3(SplitAlgorithm):
    ...
    """
    def __init__(self, featurePercentile: int = None, threads: int = 4, executor: str = 'thread') -> None:
        super().__init__(featurePercentile, threads, executor)
        self._maxInfoGain = -np.inf
...
class C45(SplitAlgorithm):
    ...
    """
    def __init__(self, featurePercentile: int = None, threads: int = 4, executor: str = 'thread', epsilon: float = 1e-10) -> None:
        super().__init__(featurePercentile, threads, executor)
...
class RSA(SplitAlgorithm):
    ...
    def findBestSplit(self, data) -> tuple:
        """
