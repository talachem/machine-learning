...
class FeatureSelection(ABC):
    ...
    def __call__(self, features: np.ndarray, target: np.ndarray) -> np.ndarray:
        """
    ...
    @abstractmethod
    def _select(self, features: np.ndarray, target: np.ndarray) -> np.ndarray:
        """
...
class MutualInformation(FeatureSelection):
    ...
    @staticmethod
    def _mutualInformation(feature: np.ndarray, targets: np.ndarray) -> float:
        """
...
class ANOVA(FeatureSelection):
    ...
    @staticmethod
    def fOneWay(*args: np.ndarray) -> tuple[float, np.ndarray]:
        """
...
class KendallTau(FeatureSelection):
    ...
    @staticmethod
    def _kendallTau(feature: np.ndarray, compare: np.ndarray) -> float:
        """
